...
jsPsych.plugins['image-slider-response-modified'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.render_on_canvas) {
      ...
      if(trial.slider_width !== null){
        slider_container.style.width = 400 +'px';
      }
      // create html string with slider and labels, and add to slider container

      // <input type="range" class="jspsych-slider" value="0" min="-3" max="3" step="1" id="jspsych-image-slider-response-response" style="width: 400px;">


      html ='<input type="range" class="jspsych-slider" value="'+trial.slider_start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" id="jspsych-image-slider-response-response" style="width: 400px;">';
      html += '<div>'
      ...
      html += '"></img>';
      html += '</div>';
      html += '<div class="jspsych-image-slider-response-container" style="position:relative; margin: 0px auto 3em auto; width:400px';
      if (trial.slider_width !== null) {
        html += 400 +'px;';
      } else {
        html += 'auto;';
